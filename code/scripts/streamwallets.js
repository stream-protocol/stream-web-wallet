...
async function f() {
    ...
    while (tMin > t0) {
        ...
        console.log(`searched up to time = ${timeString(tMin)}; at page ${pageIndex} (100 per page); retrieved ${transactions.length} transactions from relayer; ${creations.length} creations of StreamWallet`)
