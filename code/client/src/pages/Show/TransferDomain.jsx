  ...
  return (
    <AnimatedSection wide onClose={onClose} title={<Title level={2}>Transfer Domain</Title>}>
      <Space direction='vertical' size='large'>
        <Hint>You will transfer ownership of domain {wallet.domain} to this address. Note that address still needs to reclaim reverse address lookup. If it is an StreamWallet, its owner will be able to do so in the user interface.</Hint>
