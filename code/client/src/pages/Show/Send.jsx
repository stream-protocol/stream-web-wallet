    ...
    <AnimatedSection wide title={<Title level={isMobile ? 5 : 2}>{isMobile ? '' : 'Send: '}{titleSuffix}</Title>} onClose={onClose}>
      <AverageRow>
        <Warning>
          ...
          Centralized exchange such as Binance and crypto.com cannot detect deposits from smart contracts at this time. We are working on <Link href='https://github.com/stream-protocol/stream-web-wallet/issues/293' target='_blank' rel='noreferrer'>a new solution</Link> to address this issue in future releases.
        </Warning>
      </AverageRow>
