...
const Recovery = ({ address }) => {
  ...
  const exportRecovery = async () => {
    ...
    try {
      ...
      const filename = `${nameReplaced}-${util.safeOneAddress(address)}.recoverStreamWallet`
  ...
  return (
    <Space direction='vertical' size='large' style={{ width: '100%' }}>
      ...
      <Hint>You may send all your assets to your recovery address if you lost your authenticator. You can also recover your assets by sending 1.0 ONE from the recovery address to this wallet, after the wallet is idle for at least 14 days. If your recovery address is <b>StreamWallet DAO</b>, it means your recovery address is not yet set.</Hint>
      {util.isRecoveryAddressSet(lastResortAddress) &&
        <Row justify='end'>
