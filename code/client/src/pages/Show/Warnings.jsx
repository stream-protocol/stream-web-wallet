...
const Warnings = ({ address }) => {
  ...
  return (
    <>
      ...
      {walletOutdated && <Warning>Your StreamWallet is terribly outdated. Please create a new wallet and move your assets.</Warning>}
      ...
      {ONEUtil.getVersion(wallet) === '8.0' && !wallet.doubleOtp &&
        <Warning>
          DO NOT use this version of the wallet. Funds may be unspendable and unrecoverable. Please create a new wallet. Learn more at <Link href='https://github.com/stream-protocol/stream-web-wallet/issues/72' target='_blank' rel='noreferrer'>https://github.com/stream-protocol/stream-web-wallet/issues/72</Link>
        </Warning>}
    </>
  )
}
