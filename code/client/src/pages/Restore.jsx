      ...
      {section === Sections.Choose &&
        <AnimatedSection>
          ...
          <Space direction='vertical' size='large'>
            <Heading>Sync StreamWallet across devices</Heading>
            <LocalImport />
            <Hint>Requires the same StreamWallet from another device. Does not require authenticator. To use this, you need to export .StreamWallet file under "About" tab from another device. For best security, you should delete the .StreamWallet file after that.</Hint>
          </Space>
        </AnimatedSection>}
