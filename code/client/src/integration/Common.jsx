      ...
      {from && !selectedWallet &&
        <AverageRow>
          <Space direction='vertical'>
            <Paragraph>The app wants you to use your StreamWallet at this address:</Paragraph>
            <Paragraph> <WalletAddress addressStyle={{ padding: 0 }} useHex={useHex} showLabel address={from} /></Paragraph>
            <Paragraph>However, you do not have that StreamWallet address in this device. Please go back to the app, and choose an StreamWallet address that you own. If you do own that StreamWallet address but it is not appearing in your wallets, you need restore the wallet first using "Restore" feature with your Google Authenticator.</Paragraph>
          </Space>
        </AverageRow>}
      {from && selectedWallet &&
        <AverageRow>
