      ...
      >
        <AverageRow style={{ margin: 0 }}>
          <Space direction='vertical' style={{ maxWidth: '100%' }}>
            <Title level={3}>"{caller}" wants your StreamWallet to do something </Title>
